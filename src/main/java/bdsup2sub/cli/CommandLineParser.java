...
public class CommandLineParser {
    ...
    private Optional<OutputMode> outputMode = Optional.empty();
    private boolean loadSettings;
    private Optional<Resolution> resolution = Optional.empty();
    private Optional<Double> sourceFrameRate = Optional.empty();
    private Optional<Double> targetFrameRate = Optional.empty();
    private boolean convertFpsMode;
    private boolean synchronizeFpsMode;
    private Optional<Double> delay = Optional.empty();
    private Optional<ScalingFilter> scalingFilter = Optional.empty();
    private Optional<PaletteMode> paletteMode = Optional.empty();
    private Optional<Double> minimumDisplayTime = Optional.empty();
    private Optional<Double> maximumTimeDifference = Optional.empty();
    private Optional<CaptionMoveModeY> moveModeY = Optional.empty();
    private double screenRatio;
    private int moveYOffset;
    private Optional<CaptionMoveModeX> moveModeX = Optional.empty();
    private Optional<Integer> moveXOffset = Optional.empty();
    private Optional<Integer> cropLines = Optional.empty();
    private Optional<Integer> alphaCropThreshold = Optional.empty();
    private Optional<Double> scaleX = Optional.empty();
    private Optional<Double> scaleY = Optional.empty();
    private Optional<Boolean> exportPalette = Optional.empty();
    private Optional<Boolean> exportForcedSubtitlesOnly = Optional.empty();
    private Optional<ForcedFlagState> forcedFlagState = Optional.empty();
    private Optional<Boolean> swapCrCb = Optional.empty();
    private Optional<Boolean> fixInvisibleFrames = Optional.empty();
    private Optional<Boolean> verbose = Optional.empty();
    private Optional<Integer> alphaThreshold = Optional.empty();
    private Optional<Integer> lumLowMedThreshold  = Optional.empty();
    private Optional<Integer> lumMedHighThreshold = Optional.empty();
    private Optional<Integer> languageIndex = Optional.empty();
    ...
    public void parse(String... args) throws ParseException {
        ...
        if (line.hasOption(HELP)) {
            ...
            exportPalette = line.hasOption(EXPORT_PALETTE) ? Optional.of(Boolean.TRUE) : Optional.<Boolean>empty();
            exportForcedSubtitlesOnly = line.hasOption(EXPORT_FORCED_SUBTITLES_ONLY) ? Optional.of(Boolean.TRUE) : Optional.<Boolean>empty();
            parseForcedFlagOption(line);
            swapCrCb = line.hasOption(SWAP_CR_CB) ? Optional.of(Boolean.TRUE) : Optional.<Boolean>empty();
            fixInvisibleFrames = line.hasOption(FIX_INVISIBLE_FRAMES) ? Optional.of(Boolean.TRUE) : Optional.<Boolean>empty(); // TODO: accept only for SUB/IDX or SUP/IFO as target
            verbose = line.hasOption(VERBOSE) ? Optional.of(Boolean.TRUE) : Optional.<Boolean>empty();
